...
export const DISH_CATALOG: DishTemplate[] = [
  // Desayunos
  {
    ...
    category: 'Desayunos',
    defaultPortion: '1 porci├│n (300g)',
    calories: 380,
    protein: 28,
    carbs: 30,
    fat: 12,
    tags: ['Alto en Prote├¡na', 'Bajo en Grasa', 'Saciante']
  },
  {
    id: 'dish-2',
    name: 'Avena trasnochada con prote├¡na y ar├índanos',
    category: 'Desayunos',
    defaultPortion: '1 taz├│n (280g)',
    calories: 420,
    protein: 32,
    carbs: 48,
    fat: 8,
    tags: ['Alto en Prote├¡na', 'Fibra', 'R├ípido']
  },
  {
    id: 'dish-3',
    ...
    carbs: 35,
    fat: 24,
    tags: ['Grasas Saludables', 'Energ├⌐tico']
  },
  {
    id: 'dish-4',
    ...
    carbs: 45,
    fat: 6,
    tags: ['Probi├│ticos', 'R├ípido', 'Digestivo']
  },

  // Almuerzos / Cenas
  {
    id: 'dish-5',
    name: 'Salm├│n a la plancha con esp├írragos y quinua',
    category: 'Almuerzos / Cenas',
    defaultPortion: '1 filete + guarnici├│n (350g)',
    calories: 580,
    protein: 42,
    carbs: 40,
    fat: 26,
    tags: ['Omega 3', 'Alto en Prote├¡na', 'Antiinflamatorio']
  },
  {
    id: 'dish-6',
    name: 'Pechuga de pollo al lim├│n con arroz integral y br├│coli',
    category: 'Almuerzos / Cenas',
    defaultPortion: '1 porci├│n completa (380g)',
    calories: 520,
    protein: 48,
    carbs: 45,
    fat: 12,
    tags: ['Cl├ísico Fitness', 'Alto en Prote├¡na', 'Bajo en Grasa']
  },
  {
    id: 'dish-7',
    name: 'Bowl mediterr├íneo con garbanzos, at├║n y aguacate',
    category: 'Almuerzos / Cenas',
    ...
    carbs: 42,
    fat: 18,
    tags: ['Mediterr├íneo', 'Fibra', 'Sin Gluten']
  },
  {
    id: 'dish-8',
    name: 'Lomo de res salteado al wok con vegetales frescos',
    category: 'Almuerzos / Cenas',
    defaultPortion: '1 porci├│n al wok (360g)',
    calories: 620,
    protein: 50,
    carbs: 48,
    fat: 22,
    tags: ['Hierro', 'Alto en Prote├¡na', 'Hipertrofia']
  },
  {
    id: 'dish-9',
    name: 'Tacos de pescado blanco con tortilla de ma├¡z y pico de gallo',
    category: 'Almuerzos / Cenas',
  ...
  // Colaciones
  {
    ...
    carbs: 22,
    fat: 9,
    tags: ['Snack R├ípido', 'Grasas Buenas']
  },
  {
    id: 'dish-11',
    name: 'Batido de prote├¡na Isolate con leche de almendras',
    category: 'Colaciones',
    ...
    carbs: 4,
    fat: 2,
    tags: ['Bajo en Carbos', 'Post-entreno', 'L├¡quido']
  },
  {
    id: 'dish-12',
    name: 'Mix de frutos secos natural y semillas de calabaza',
    category: 'Colaciones',
    defaultPortion: '1 pu├▒ado (35g)',
    calories: 210,
    protein: 6,
    carbs: 8,
    fat: 18,
    tags: ['Keto friendly', 'Energ├¡a duradera']
  },
  {
    id: 'dish-13',
    ...
    carbs: 4,
    fat: 6,
    tags: ['Bajo en Calor├¡as', 'Saciedad', 'Proteico']
  },
  ...
  // Bebidas y Batidos
  {
    ...
    carbs: 18,
    fat: 1,
    tags: ['Detox', 'Vitam├¡nico', 'Bajo en Calor├¡as']
  },
  {
    id: 'dish-15',
    name: 'Batido de pl├ítano, creatina y cacao puro',
    category: 'Bebidas y Batidos',
    ...
    carbs: 35,
    fat: 4,
    tags: ['Energ├⌐tico', 'Recuperador muscular']
  }
];
...
export const createDefaultMeals = (multiplier = 1): MealConfig[] => [
  ...
  { id: 'm-2', name: 'Colaci├│n matutina', suggestedTime: '11:00 AM', targetCalories: Math.round(150 * multiplier), isEnabled: true, assignedMenus: [] },
  { id: 'm-3', name: 'Almuerzo', suggestedTime: '14:00 PM', targetCalories: Math.round(600 * multiplier), isEnabled: true, assignedMenus: [] },
  { id: 'm-4', name: 'Colaci├│n vespertina', suggestedTime: '17:30 PM', targetCalories: Math.round(150 * multiplier), isEnabled: true, assignedMenus: [] },
...
export const createDefaultWeekStructure = (multiplier = 1, populateSampleMenus = false): DayPlanStructure[] => {
  return DAYS_OF_WEEK.map((day, dayIndex) => {
    const meals = createDefaultMeals(multiplier).map((meal, mealIndex) => {
      ...
      // Si populateSampleMenus es true, asignamos men├║s por defecto a Lunes y Martes para que la grilla no est├⌐ vac├¡a
      if (populateSampleMenus && (dayIndex === 0 || dayIndex === 1)) {
        ...
        } else if (mealIndex === 1 || mealIndex === 3) { // Colaci├│n
...
export const INITIAL_PLANS: WeeklyPlan[] = [
  {
    ...
    days: createDefaultWeekStructure(1.0, true), // Con men├║s precargados
